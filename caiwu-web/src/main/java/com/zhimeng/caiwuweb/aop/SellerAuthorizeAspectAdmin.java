...
@Component
@Aspect
public class SellerAuthorizeAspectAdmin {

    @Autowired
    CustomerMapper customerMapper;
    @Autowired
    private RedisUtil redisUtil;
    @Pointcut(value = "@annotation(com.zhimeng.caiwuweb.aop.AdminAccess)")
    void access() {}
    ...
    void doVerify() throws Exception {
        ...
        if (customer.getCusAuthority()!=3){
            throw new AuthorityNotException("没有权限访问");
        }
    }
